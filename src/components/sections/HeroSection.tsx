    ...
    <section className="relative min-h-[85vh] bg-gradient-to-b from-amber-50/70 via-[#faf6f0] to-[#f7f2ea] flex items-center py-16 sm:py-24 border-b border-amber-100/70 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 max-w-2xl animate-fadeIn">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <Link href={ctaLink}>
                <a className="btn-primary group text-base cursor-pointer hover:scale-[1.02] active:scale-[0.98] transition-all">
                  <span>{ctaText}</span>
                  <ArrowRight className="ml-2.5 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </a>
              </Link>
              <Link href="/about">
                <a className="btn-outline text-base cursor-pointer hover:scale-[1.02] active:scale-[0.98] transition-all">
          ...
          <div className="lg:col-span-5 flex items-center justify-center animate-fadeIn">
            <div className="relative w-full max-w-md">
              <div className="bg-white p-5 sm:p-6 rounded-3xl shadow-xl border border-amber-100 relative group">
                ...
                <div className="absolute -top-3 -right-3 bg-primary-800 text-white px-4 py-2 rounded-full text-xs font-black shadow-lg uppercase tracking-wider flex items-center gap-1.5 animate-bounce">
